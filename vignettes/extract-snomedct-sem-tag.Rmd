---
title: "Extract semantic tag from SNOMED CT descriptions"
...
Understanding these tags helps researchers interpret what types of clinical activities their codelists capture and identify potential biases in coding patterns.
For example, a depression screening codelist might include procedures (the act of screening), observable entities (measurable scores), and findings (clinical conclusions), each with different recording patterns that could affect research interpretation.
